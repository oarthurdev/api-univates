...
class PersonList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setDatabase('persons');            // defines the database
        ...
        $column_bt = new TDataGridColumn('birth_date', 'Birth Date', 'left');
        $column_cpf = new TDataGridColumn('cpf', 'CPF', 'left');
        $column_sex = new TDataGridColumn('sex', 'Sex', 'left');
        ...
        $this->datagrid->addColumn($column_bt);
